...
// console.log(path.toNamespacedPath('D:/nodejs/hello.js')); // path.toNamespacedPath() method converts a file path into a namespaced path, if necessary. In POSenvironment, this function returns a string representation of the path as a string with the following format:  'D:/nodejs/hello.js ' and the following format: 'D:/nodejs/world. JS: ' and the following format: ' ' and the following format string for the path relative 
